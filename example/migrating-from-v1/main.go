...
import (
	qrv2 "github.com/WilliamNHarvey/go-qrcode/v2"
	"github.com/WilliamNHarvey/go-qrcode/writer/standard"

	qrv1 "github.com/WilliamNHarvey/go-qrcode"
)

func main() {
	// draw a QRCode image with
	// - "https://github.com/WilliamNHarvey/go-qrcode" source text
	// - circle shape
...
func v1() {
	...
	qrc, err := qrv1.NewWithConfig("https://github.com/WilliamNHarvey/go-qrcode", encodeConfig,
...
func v2() {
	qrc, err := qrv2.NewWith("https://github.com/WilliamNHarvey/go-qrcode",
